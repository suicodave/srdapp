                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><a data-toggle="modal"
                                ...
                                <i class="ace-icon fa fa-pencil bigger-120"></i></a> |
                                    <button class="btn btn-xs btn-danger dpassingID" data-did="{{$itemservices->sid}}" onclick="openModal('exampleID')"><i class="ace-icon fa fa-trash-o bigger-120"></i></button>
                                </td>
                        </tr>
                        @endforeach
                        <tbody>
...
<form action="{{route('deleteservices')}}" method="POST">
    <div id="deleteModal" class="modald">
        <div class="modald-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Delete Services Type</h4>
