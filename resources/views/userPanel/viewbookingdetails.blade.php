...
@section('content')
<div class="row">
    <form action="{{route('updatebooking')}}" method="POST">
    <div class="col-sm-10 col-sm-offset-1">
        <div class="widget-box transparent" id="printableArea">
            <div class="widget-header widget-header-large">
                ...
                $booking= Booking::where('bookingstatus','New')->latest('txnNumber')->first();
                ...
                <div class="widget-toolbar no-border invoice-info">
                    <span class="invoice-info-label">Transaction#:</span>
                        ...
                        <span class="red"><input type="hidden" name="txnno" value="{{$pnid}}">{{$pnid}}</span>
        ...
        <div>
            <input type="submit" name="submit" class="btn btn-success btn-sm" value="Proceed Booking">
        </div>
    </div>
    @csrf
    </form>
